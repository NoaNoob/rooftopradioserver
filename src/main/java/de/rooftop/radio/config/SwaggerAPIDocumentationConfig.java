...
public class SwaggerAPIDocumentationConfig {
	...
	ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder().title("Person REST CRUD operations API in Spring-Boot 2")
				...
				.termsOfServiceUrl("").version("0.0.1-SNAPSHOT").contact(new Contact("Satish Sharma",
						"https://github.com/hellosatish/monitoring/person", "https://github.com/hellosatish"))
				.build();
	}
	...
	public Docket configureControllerPackageAndConvertors() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("de.rooftop.radio")).build()
